...
<body>
<p>Previous Messages: %s </p>
<p><b>Current Message: %s </b></p>
</form>
</body>
</html>
"""
...
def application(environ, start_response): 
    ...
    if path == '/echo_wsgi.html':
        ...
        message_now=urlparse.parse_qs(environ['QUERY_STRING'])['message'][0]
        print "current history: %d" %(len(messages_old))

        page=message_template %(messages_old, message_now)
        messages_old.append(message_now)
    else:
